...
for i in range(0,x):
    b=input("enter whatever u wanna add in list ")
    a.append(b) 
print(a)
...
for i in range(0,x):
    b=input("enter you add in list ")
    a.append(b)
print(a)
m=input("Enter you find in list")
cont=a.count(m)
if(cont>0):
    print("total no of element occur in list is ",cont)
else:
    print("you find element not in this list")
...
x=int(input("enter total no of element in list"))
for i in range(0,x):
    b=int(input("enter no to add in list "))
    a.append(b)
    a.sort()
print(a)
